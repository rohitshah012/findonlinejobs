                ...
                <TableBody>
                    {
                        filterJobs?.map((job) => (
                            <tr key={job._id}>
                                ...
                                <TableCell>{job?.createdAt?.split("T")[0] || "NA"}</TableCell>
                                <TableCell className="text-right cursor-pointer">
                                    <Popover>
                                        ...
                                        <PopoverContent className="w-32">
                                            ...
                                            <div onClick={()=> handleDeleteJob(job._id)} className='flex items-center w-fit gap-2 cursor-pointer mt-2 text-red-600 hover:text-red-800'>
